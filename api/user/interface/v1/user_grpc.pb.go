...
func (c *userClient) Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*UserReply, error) {
	out := new(UserReply)
	err := c.cc.Invoke(ctx, "/api.user.interface.v1.User/Login", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) Register(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*UserReply, error) {
	out := new(UserReply)
	err := c.cc.Invoke(ctx, "/api.user.interface.v1.User/Register", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _User_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.user.interface.v1.User/Login",
	}
...
func _User_Register_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.user.interface.v1.User/Register",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var User_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.user.interface.v1.User",
	...
	Metadata: "api/user/interface/v1/user.proto",
}
